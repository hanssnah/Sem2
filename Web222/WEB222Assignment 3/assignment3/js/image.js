...
function imageload(){
    var secondimg = document.body.querySelector("#secondimg");
    for(var i =0; i< images.length; i++){
        secondimg.innerHTML += "<figure> <img src='"+ images[i].url + "' alt = '" + images[i].alt + "'><figcaption>" + images[i].caption + "</figcaption></figure>";
